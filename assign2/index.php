  ...
  ?>
    ...
    <div class="container">
        <div class="slider-wrapper">
            <div class="slider">
                <img id="slider-1" src="images/Sliderimage1.png" alt="Slide1">
                <img id="slider-2" src="images/Sliderimage2.png" alt="Slide2">
            </div>
        ...
        <div class="foot-container">
          <div class="row">
            <div class="footer-col">
              <h4>About Us</h4>
              <ul>
                <li><a href="memberprofileyassar.php">Yassar Lutfan</a></li>
                <li><a href="memberprofilenoah.php">Noah Ting</a></li>
                <li><a href="memberprofileguang.php">Ang Guan Xiang</a></li>
                <li><a href="memberprofileedmund.php">Edmund Yu</a></li>
              </ul>
            </div>
            <div class="footer-col">
              <h4>Acknowledgement</h4>
              <ul>
                <li><a href="acknowledgement.php">Mentions</a></li>
              </ul>
            </div>
            <div class="footer-col">
              <h4>Enhancement</h4>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do {
        if (
            ...
            empty($enquiry) || empty($reg_date)
        ) {
            $errorMessage = "All fields are required";
            break;
        }

        $sql = "INSERT INTO enquiry(first_name, last_name, email, street_adress, city, malaysia_state, postcode, phone_number, enquiry_type, enquiry, reg_date)" . 
                    "VALUES('$first_name', '$last_name', '$email', '$street_adress', '$city', '$malaysia_state', '$postcode', '$phone_number', '$enquiry_type', '$enquiry', '$reg_date')";
    ...
    <div>
        ...
        <form method="post">
            ...
            <div>
                <label>Enquiry</label>
                <div>
                    <textarea name="enquiry" class = "form-control" required="required" rows="4" cols="100" placeholder="What's on your mind?" value = "<?php echo $enquiry; ?>"></textarea><br>
                </div>
            </div>
